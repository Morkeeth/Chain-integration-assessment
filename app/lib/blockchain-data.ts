...
export class BlockchainDataService {
  private static readonly KNOWN_CHAINS: Record<string, BlockchainInfo> = {
    ...
    'fogo': {
      name: 'Fogo',
      ticker: 'FOGO',
      rpcUrl: 'https://rpc.fogo.network',
      iconUrl: 'https://cryptologos.cc/logos/fogo-logo.png',
      chainId: 'fogo-1',
      explorerUrl: 'https://explorer.fogo.network',
      githubRepo: 'https://github.com/fogo-network',
      chainType: 'Custom',
      isTestnet: false,
    }
  };
